...
class Train:
    def __init__(self) -> None:
        ...
        self.train_data_path="/root/laic/data/train.txt"
        #self.eval_data_path = get_eval_data_path()
        self.eval_data_path="/root/laic/data/dev.txt"
        #self.test_data_path = get_test_data_path()
        self.test_data_path ="/root/laic/data/test.txt"
    ...
    def train(self, use_pretrained_w2v=False, model_type="bilstm-crf"):
        ...
        ner_model.train(train_word_lists, train_tag_lists, dev_word_lists, dev_tag_lists, test_word_lists,
